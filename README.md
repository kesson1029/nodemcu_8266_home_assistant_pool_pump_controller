...
This makes it easy to place the **NodeMCU (ESP8266)** control board in a fixed location—such as the basement near the VFD/controller—without needing to remove it or bring it back to a USB port or use a laptop. **All the ESP8266 requires is a Wi-Fi connection on your local network.**
